...
class Create extends Component {
	...
	copyUrl = () => {
        ...
        let text1 = text.substr(30, 24);
        console.log(text1);
        let text3 = "http://localhost:3000/videocon/" + `${text1}`;
        this.setState({text2: text3})
					...
					<div className="joinPage">
						...
						<div className="videoContainer1">
							...
							<div className="videoContainer3">
								...
								<p>Meeting link</p>
								<input  variant="filled" value={this.state.text2} disable="true" />
